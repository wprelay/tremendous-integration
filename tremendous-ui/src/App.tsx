    ...
    <div>
      {loading ? (
        ...
        <HashRouter>
          ...
          <div>
            <AppHeader />
            <nav className="relay-wp-nav-bar wrt-flex xl:wrt-justify-start lg:wrt-justify-start lg:wrt-gap-5 md:wrt-gap-5 ">
              <NavLink
              ...
              >
                ...
                <span className="wrt-ml-2 xl:wrt-text-4 lg:wrt-text-3.5 wrt-text-xs wrt-flex wrt-items-center">
                  Settings
                </span>
              </NavLink>
              <NavLink
