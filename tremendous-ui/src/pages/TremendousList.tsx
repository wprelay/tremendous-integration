...
export const TremendousList = () => {
  const [tremendousItems, setTremendousItems] =
    useState<null | payoutItemProps>(null);
  ...
  return (
    <div className="wrt-py-2">
      <div className="wrt-flex wrt-justify-between wrt-my-4 wrt-mx-5">
        <div className="wrt-flex wrt-justify-between lg:wrt-gap-8 wrt-items-center md:wrt-gap-8 wrt-gap-4">
          <span className="wrt-flex wrt-gap-2 wrt-items-center  ">
            <span className="lg:wrt-text-xl md:wrt-text-lg wrt-text-sm wrt-text-primary wrt-font-bold">
      ...
      {!loading ? (
          ...
          {searched && tremendousItems?.reward_entries?.length == 0 ? (
            <div className="wrt-flex wrt-items-center wrt-flex-col wrt-justify-center wrt-text-center wrt-h-full">
              <div className="wrt-mx-auto wrt-my-auto wrt-flex wrt-flex-col wrt-gap-5 wrt-p-5">
                <div>
                  <i className="wpr wpr-list-empty wrt-text-6xl "></i>
                </div>
                <div>
                  <span className="wrt-text-lg wrt-font-bold">
                    The sale detail you are looking for is not found
                  </span>
                </div>
                <div>
                  <p className="wrt-text-sm ">
                    Uh oh, your order list is looking a little empty! Looks like
              ...
              <div className="wrt-h-full">
                <div className="wrt-flex wrt-flex-col wrt-gap-4">
                  <div className="wrt-flex wrt-justify-between wrt-mt-5 wrt-w-full wrt-px-4">
                    <div className=" wrt-text-grayprimary wrt-font-bold xl:wrt-text-xs md:wrt-text-2.5 wrt-w-1/4 wrt-text-2.5 wrt-uppercase">
                      Receiver Email
                    </div>
                    <div className=" wrt-text-grayprimary wrt-font-bold xl:wrt-text-xs md:wrt-text-2.5 wrt-w-1/4 wrt-text-2.5 wrt-uppercase">
                      Order Id
                    </div>
                    <div className=" wrt-text-grayprimary wrt-font-bold xl:wrt-text-xs md:wrt-text-2.5 wrt-w-1/6 wrt-text-2.5 wrt-uppercase">
                      Amount
                    </div>
                    <div className=" wrt-text-grayprimary wrt-font-bold xl:wrt-text-xs md:wrt-text-2.5 wrt-w-1/7 wrt-text-2.5 wrt-uppercase">
                      Status
                    </div>
                  </div>
                  <div className="wrt-flex wrt-flex-col wrt-gap-4">
                    {tremendousItems?.reward_entries.map(
                      (item: TremendousItemEachEntryProp, index: any) => {
                        return (
                          <Card
                            key={index}
                            className="wrt-flex wrt-justify-between wrt-p-4 !wrt-shadow-md wrt-h-18 wrt-items-center"
                          >
                            <div className="wrt-text-primary xl:wrt-text-sm wrt-font-bold lg:wrt-text-xs md:wrt-text-2.5  wrt-text-2.5 wrt-w-1/4 ">
                              #{item.receiver_email}
                            </div>
                            <div className="wrt-text-primary xl:wrt-text-sm wrt-font-bold lg:wrt-text-xs md:wrt-text-2.5  wrt-text-2.5 wrt-w-1/4 ">
                            ...
                            <div className="wrt-text-primary xl:wrt-text-sm wrt-font-bold lg:wrt-text-xs md:wrt-text-2.5  wrt-text-2.5 wrt-w-1/6 ">
                              {item.amount ? (
                                <span>
                            ...
                            <div className="wrt-w-1/7">
                              <Badge
                                className={`${item.status != "success" ? "wrt-bg-red-600 hover:wrt-bg-red-600" : "!wrt-bg-green-600 hover:wrt-bg-green-600"} `}
                              >
                                {item.status}
                              </Badge>
                            </div>
                ...
                <div className="wrt-flex wrt-justify-end wrt-items-center wrt-my-4">
                  <div className="pagination">
                    <Pagination
                      ...
                      pageCount={tremendousItems?.total_pages || 1}
                      limit={tremendousItems?.per_page || 5}
                      loading={false}
        ...
        <div className="wrt-h-[65vh] rwr-w-full wrt-flex">
