  ...
  return (
    <div className="wrt-py-2">
      <div className="wrt-flex wrt-justify-between wrt-gap-3 wrt-items-center wrt-m-4">
        <div>
          <span className="wrt-text-xl wrt-leading-5 wrt-font-bold">
            Settings
          </span>
        ...
        <CardContent className="!wrt-p-0">
          {loading ? (
            ...
            <div className="wrt-w-full wrt-flex wrt-flex-col">
              <div className="wrt-flex wrt-flex-row wrt-py-10 wrt-border-b-1 wrt-rounded wrt-px-6 wrt-gap-5">
                <div className="wrt-flex-1 wrt-flex wrt-flex-col wrt-gap-2">
                  <h3 className="wrt-text-4 wrt-font-bold wrt-leading-5">
                    Sandbox Mode
                  </h3>
                  <p className="wrt-text-sm wrt-text-grayprimary">
                    Enable if you want test in Sandbox environment
                  </p>
                </div>
                    ...
                    <div className="wrt-flex wrt-flex-col wrt-justify-start wrt-gap-2 wrt-w-full">
                      <div className="wrt-flex wrt-justify-between wrt-gap-2 wrt-w-full">
                        <Input
                          ...
                          onChange={(e: any) => {
                            setSettings(
                              handleFields(settings, e.target.value, "api_key"),
                            );
                          }}
                        />
                        <button
              ...
              <div className="wrt-w-full wrt-flex wrt-flex-col">
                <div className="wrt-flex wrt-flex-row wrt-py-10 wrt-border-b-1 wrt-rounded wrt-px-6 wrt-gap-5">
                  ...
                  <div className="wrt-flex-1 wrt-flex-row wrt-gap-1">
                    <div className="wrt-flex wrt-flex-row wrt-items-center wrt-gap-2 wrt-w-full">
                      <Select
                        onValueChange={(option: any) => {
                          setSettings(
                            handleFields(settings, option, "campaign_id"),
                          );
                        }}
                      ...
                      {dropDownLoading && (
                        <span className="wrt-mx-2">
                          <ClipLoader cssOverride={override} size={"20px"} />
                        </span>
                      )}
                    </div>
                    <p className=" wrt-text-xs wrt-text-destructive wrt-pt-1.5">
              ...
              <div className="wrt-w-full wrt-flex wrt-flex-col">
                <div className="wrt-flex wrt-flex-row wrt-py-10 wrt-border-b-1 wrt-rounded wrt-px-6 wrt-gap-5">
                  ...
                  <div className="wrt-flex-1 wrt-flex-row wrt-gap-1">
                    <div className="wrt-flex wrt-flex-row wrt-justify-start wrt-items-center wrt-gap-2 wrt-w-full">
                      <Select
                        onValueChange={(option: any) => {
                          setSettings(
                            handleFields(settings, option, "funding_source"),
                          );
                        }}
